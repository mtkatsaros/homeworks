...
public class ChangeCalculator {
    ...
    public static int calculateChange(int cents, int currentCoin) {
    	//correct complete combination base case
    	if(cents == 0)
    		return 1;
    	//incorrect combination base case
    	if(cents < 0)
    		return 0;
    	int combos = 0;
    	
    	//recursively calculate the total combinations
    	for(int coin = currentCoin; coin < coins.length; coin++) 
    		combos += calculateChange(cents - coins[coin], coin);
    	return combos;
    }
